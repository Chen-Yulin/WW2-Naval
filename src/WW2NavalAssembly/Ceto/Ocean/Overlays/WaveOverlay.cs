...
namespace Ceto
{
	...
	public class WaveOverlay
	{
        ...
        /// </summary>
		public float NormalizedAge { get { return Mathf.Clamp01(Age / Duration); } }
        ...
        /// and the bounding box and what ever 
        /// the superclass needs to have updated.
        /// </summary>
...
//
//			if(x >= bounds.center.x - bounds.extents.x &&
